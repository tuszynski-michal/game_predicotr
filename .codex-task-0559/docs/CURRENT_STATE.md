...
- Preflight geometrii przypina najnowszy zgodny manifest tej samej gry,
  selekcji i source manifestu. Exact v3 ma pierwszeństwo przed zgodnym
  przejściem v2→v3, a semantycznie identyczne żądanie zachowuje dotychczasową
  idempotencję.
- Worker zachowuje bezpieczne wpisy, przelicza review, zmienione ręczne
  geometrie i zależności kotwic. Checkpoint składa się z checksummowanych
...
- Kontrola odczytowa manifestu stagingu 45163–70371 potwierdziła dokładnie
  `1686` wyników do ponownego użycia i `1115` do przeliczenia z `2801` źródeł.
  Nie uruchomiono nowego joba ani usług z worktree.

...
## D-393 — Preflight geometrii używa przypiętej bazy i trwałych shardów
...
- **Compatibility:** exact v3 zachowuje niezmienione `registered` i
  ...
  przeliczane. Nowe pola inputu, manifestu i odpowiedzi postępu są opcjonalne.

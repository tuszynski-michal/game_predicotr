...
| T13b | done, `v0.10.333`     | Handler V7 używa schema 4 i lokalnego manifestu, utrwala checkpoint/propozycje bez outputu oraz fail-closed odmawia bez kalibracji; API pozostaje zablokowane. |

...
- Następny krok to T04 / TASK-0683; wymaga jawnego polecenia rozpoczęcia kolejnego taska. STOP A blokuje dalszy plan przy niepustej tabeli, legacy location, aktywnej migracji lub nierozpoznanej zależności.

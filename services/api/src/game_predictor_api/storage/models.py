...
class RecognizedBoardModel(Base):
    ...
    __table_args__ = (
        CheckConstraint(
            ...
            "'object' AND "
            "((geometry_qualification->>'version' = 'manual-geometry-qualification-v1' AND NOT "
            "(geometry_qualification ? 'includeInPartialGridTraining') AND NOT "
            "(geometry_qualification ? 'fullyUnavailableCellIndices')) OR "
            ...
            "jsonb_typeof(geometry_qualification->'includeInPartialGridTraining') = 'boolean' AND "
            "jsonb_typeof(geometry_qualification->'fullyUnavailableCellIndices') = 'array')) AND "
            ...
            "(completeness_status "
            "= 'complete' AND COALESCE(geometry_qualification->'includeInPartialGridTraining', "
...
class ImageImportGeometryGuardDecisionModel(Base):
    ...
    __table_args__ = (
        CheckConstraint(
            ...
            "jsonb_typeof(geometry_qualification->'fullyUnavailableCellIndices') = 'array')) AND "
            "geometry_qualification->'unavailableCellIndices' = to_jsonb(unavailable_cell_indices) "
            "AND ((disposition = 'partial' AND geometry_qualification->>'completenessStatus' = "
            ...
            "(disposition = 'corrected_full' AND geometry_qualification->>'completenessStatus' = "
            "'complete' AND COALESCE(geometry_qualification->'includeInPartialGridTraining', "
            "'false'::jsonb) = 'false'::jsonb AND "
            "((geometry_qualification->'excludeFromGeometryTraining' = 'true'::jsonb AND "
            "geometry_qualification->>'exclusionReason' = 'manual_exclusion') OR "

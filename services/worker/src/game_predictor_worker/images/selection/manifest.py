...
ACTIVE_SELECTOR_VERSION = LABEL_LATTICE_SAFE_SELECTOR_VERSION
...
PARTIAL_LAYOUT_ANCHORED_SELECTOR_VERSIONS = frozenset(
    {PARTIAL_LAYOUT_ANCHORED_SELECTOR_VERSION, LABEL_LATTICE_SAFE_SELECTOR_VERSION}
)
...
DEFAULT_SELECTOR_MANIFEST = LABEL_LATTICE_SAFE_SELECTOR_MANIFEST_V1010

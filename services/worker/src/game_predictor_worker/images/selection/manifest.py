...
ACTIVE_SELECTOR_VERSION = SEQUENCE_VALIDATED_SELECTOR_VERSION
PROOF_FIRST_SELECTOR_VERSIONS = frozenset(
    {PROOF_FIRST_SELECTOR_VERSION, SEQUENCE_VALIDATED_SELECTOR_VERSION}
)
...
DEFAULT_SELECTOR_MANIFEST = SEQUENCE_VALIDATED_SELECTOR_MANIFEST_V1020
